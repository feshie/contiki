...
/**
 * LoWPANSniffer is an application that, when paired with a sniffer using a
 * slip-bridge, takes input through a serial port receiving raw packet data.
 * This packet data provides network data of a RPL-based network, presenting all
 * packets seen in table form and mapping out the nodes data flow on a JGraphT
 * graph.
 *
 * @author Ed Crampin
 */
public class LoWPANSniffer {
    ...
    /**
     * Once the port has been chosen, the init method sets up the Serial
     * Listener and all other UI for the application.
     *
    ...
    public static void init(String port) {
        ...
        frame.setTitle("LoWPANSniffer - Node Map");
