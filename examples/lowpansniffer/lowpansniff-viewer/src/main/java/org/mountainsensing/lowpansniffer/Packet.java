...
public class Packet {
     ...
     * @return formatted string of destination address, or raw destination address
     */
    public String dst() {
        try {
    ...
    /**
     * Returns the hex of the packet with the option to format the output string.
    ...
    public String hex(boolean formatted) {
        ...
        for(int i = 0; i < this.raw.length; i++) {
            ...
            if(i == 0 || i == this.raw.length - 1) continue;
     ...
     * @return the system's current time in milliseconds when the packet was instantiated
     */
