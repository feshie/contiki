...
public class PacketHandler {
    ...
    private static final int ICMP_TYPE = 58;
    
    /**
     * A (currently messy) implementation of how to decipher the raw bytes of
     * a packet that is received by the sniffer.
     ...
     * @throws StringIndexOutOfBoundsException when the packet is corrupt, this can be thrown
     */
    public Packet parsePacket(byte[] packetBytes) throws UnsupportedOperationException, StringIndexOutOfBoundsException {
        ...
        for(int i = 0; i < packetBytes.length; i++) {
            if(i == 0 || i == packetBytes.length - 1) continue;
