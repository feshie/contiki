...
cc1120_register_config(void)
{
   ...
   cc1120_spi_single_write(CC1120_ADDR_SYNC3, 0x7A);           // Sync Word Configuration [31:24].
   cc1120_spi_single_write(CC1120_ADDR_SYNC2, 0x0E);           // Sync Word Configuration [23:16].
   cc1120_spi_single_write(CC1120_ADDR_SYNC1, 0x90);           // Sync Word Configuration [15:8].
   cc1120_spi_single_write(CC1120_ADDR_SYNC0, 0x4E);           // Sync Word Configuration [7:0].
   cc1120_spi_single_write(CC1120_ADDR_SYNC_CFG1, 0x05);       // Sync Word Detection Configuration Reg. 1.
   cc1120_spi_single_write(CC1120_ADDR_SYNC_CFG0, 0x1F);       // Sync Word Length Configuration Reg. 0.
   ...
   cc1120_spi_single_write(CC1120_ADDR_FREQ2, 0x6B);           // Frequency Configuration [23:16].
   cc1120_spi_single_write(CC1120_ADDR_FREQ1, 0xE0);           // Frequency Configuration [15:8].
